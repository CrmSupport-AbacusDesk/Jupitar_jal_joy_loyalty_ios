...
export class FurnitureIdeasdetailPage {
    ...
    constructor(public navCtrl: NavController, public navParams: NavParams,public service:DbserviceProvider,public db:DbserviceProvider,public loadingCtrl:LoadingController,public translate:TranslateService,public constn:ConstantProvider,public storage:Storage) {
    ...
    updateShopImage()
    {
        ...
        this.navCtrl.push(FurnitureIdeasPage,{'data':this.productDataImg});
