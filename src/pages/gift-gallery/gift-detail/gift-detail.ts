...
export class GiftDetailPage {
    ...
    presentCancelPolicyModal() {
        let gift = 'gift'
        let contactModal = this.modalCtrl.create(CancelpolicyModalPage,{'karigar_id':this.service.karigar_id,'gift_id':this.gift_id, 'redeem_type':gift});
    ...
    getGiftDetail(gift_id)
    {
        ...
        .subscribe( (r) =>
        {
            ...
            this.redeemable_amount=parseInt(r['redeemable_amount']);
            ...
            if(this.redeemable_amount < this.gift_detail.coupon_points)
            {
